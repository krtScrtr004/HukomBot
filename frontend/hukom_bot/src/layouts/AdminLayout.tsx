			...
			<section className="flex-1 overflow-y-auto p-2 scrollbar-thin">
				<nav className="space-y-1" aria-label="Admin navigation">
					...
					<button
						...
						className="w-full flex items-center gap-3 rounded-sm px-3 py-2.5 text-sm font-medium text-text-secondary hover:bg-hover hover:text-text-primary transition-colors"
					>
