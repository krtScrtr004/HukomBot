...
from backend.hukom_bot.model.case_analysis_model import CaseAnalysisVersionFact
from backend.hukom_bot.schema.case_analysis_schema import CaseAnalysisVersionFactCreate
